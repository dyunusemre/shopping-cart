...
class CartTest {
    ...
    void should_reset_cart() {
        ...
        assertThat(cart.getAppliedPromotion()).isNull();
    }
    ...
    void should_remove_item() {
        ...
        cart.removeItem(1);
        //then
        assertThat(cart.getItem(1)).isNotPresent();
    ...
    void should_apply_promotion_to_cart() {
        ...
        //then
        assertThat(cart.getAppliedPromotion()).isNotNull();
        assertThat(cart.getAppliedPromotion().appliedPromotionId()).isEqualTo(9909);
